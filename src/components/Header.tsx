...
export default function Header() {
    ...
    return (
        <header className=' light:bg-VeryPaleBlueTopBGPattern light:text-VeryDarkBlueTextlight bg-VeryDarkBlueTopBGPattern text-white px-5 pb-24 rounded-b-3xl lg:h-[250px]'>
            <div className='flex flex-col md:flex-row md:justify-between md:items-center max-w-6xl mx-auto'>
            <div className='mt-8'>
                <h1 className='font-bold text-[30px] text-WhiteText light:text-VeryDarkBlueTextlight'>Social Media Dashboard</h1>
                <p className='font-bold text-DesaturatedBlueTextdark light:text-DarkGrayishBlueTextlight'>Total Followers: 23,004</p>
                <div className='border-b-1 border-DarkGrayishBlueTextlight w-full mb-4 mt-6 md:hidden'></div>
            </div>
            <div className='flex justify-between md:gap-4'>
                <p className='font-bold text-DesaturatedBlueTextdark light:text-DarkGrayishBlueTextlight'>Dark Mode</p>
